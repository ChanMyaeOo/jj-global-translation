...
const Showcase = () => {
    ...
    return (
        <div className={classes.showcase}>
            ...
            <p className={classes.showcaseContent}>Since 2010, JJ Global Translation have been using carefully-selected translators in the United Kingdom and world-wide to service our international client base providing on-time, accurate and professional translated documents, contracts, certificates and much more.</p>
            ...
            <p>JJ Global Translation, and its network of professional translators offers a wide range of translation services. Below you will find a list of the most popular:</p>
